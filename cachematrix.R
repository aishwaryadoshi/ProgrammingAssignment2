...
#<<- operator is used to assign a value to an object in an environment that is different from the 
#current environment
...
# input and checks if the inverse matrix from makeCacheMatrix(matrix) has any value in it or not.
